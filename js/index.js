...
classFloder.onclick = function(e) { //缩略图-------------单选-------------------------
	var target = e.target;
	//用事件代理方法，判断目标源如果是li或者img就切换到子数据，如果是文件夹单选；
...
$('#downLoad').on('click',function(){
	fullTip('forbidden','暂无下载链接,请与管理员联系');
})
//-------------------------------------分享----------------------------------
$('#share').on('click',function(){
	dialog({'title':'请选择分享的位置',
	'content':'<ul id="shareList"><li><a href="http://www.qzone.com" target="_blank">朋友圈</a></li><li><a href="http://www.qzone.com" target="_blank">微信</a></li><li><a href="http://connect.qq.com" target="_blank">QQ好友</a></li><li><a href="http://www.email.com" target="_blank">电子邮件</a></li><li><a href="http://www.baidu.com" target="_blank">更多</a></li></ul>'
});
//$('#shareList li').eq(0).on('click',function(){
